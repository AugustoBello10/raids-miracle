CONSTANTES_SKILLS = { "knight": {"melee": 50, "distance": 140, "shielding": 100}, "paladin": {"melee": 120, "distance": 25, "shielding": 100}, "druid": {"melee": 200, "distance": 200, "shielding": 100}, "sorcerer": {"melee": 200, "distance": 200, "shielding": 100} }
...
ALCHEMY_DATA = { "converter": { "charges": 100, "cost": 500, "base_chance": 10, "skill_factor": 0.2 }, "crystals": { "Spark Crystal": {"base_chance": 20}, "Lightning Crystal": {"base_chance": 15}, "Inferno Crystal": {"base_chance": 10} } }

ALCHEMY_RUNES = { "Sudden Death": {"min": 55, "base": 22.72, "pro": True}, "Explosion": {"min": 28, "base": 27.77, "pro": True}, "Great Fireball": {"min": 22, "base": 41.66, "pro": False}, "Heavy Magic Missile": {"min": 13, "base": 71.42, "pro": False}, "Light Magic Missile": {"min": 10, "base": 100.0, "pro": False}, "Fireball": {"min": 16, "base": 83.33, "pro": False}, "Ultimate Healing": {"min": 22, "base": 50.0, "pro": True}, "Intense Healing": {"min": 13, "base": 83.33, "pro": False} }

MINING_PICKS = { "Pick (Normal)": {"bonus_break": 0, "bonus_collect": 0.0}, "Modified Pick": {"bonus_break": 2, "bonus_collect": 0.25}, "Advanced Pick": {"bonus_break": 4, "bonus_collect": 0.50}, "Enhanced Pick": {"bonus_break": 6, "bonus_collect": 1.00} }
...
RECEITAS = {
    ...
    "Engineered Fishing Rod": { "multiplicador": 1.5, "ingredientes": {"Fishing Rod": 1, "Steel": 10}, "perde_na_falha": True },
    "Volcanic Fishing Rod": { "multiplicador": 1, "ingredientes": { "Fishing Rod": 1, "Steel": 20, "Glimmering Soil": 10}, "perde_na_falha": True },
    "Golden Fishing Rod": { "multiplicador": 0.5, "ingredientes": { "Fishing Rod": 1, "Steel": 40, "Draconian Steel": 10, "Gold Ingot": 3}, "perde_na_falha": True },
    "10x Steel Bolts": { "multiplicador": 0.4, "ingredientes": {"Bolt": 5, "Steel": 1}, "perde_na_falha": True },
}
...
ALCHEMY_MENU_CATS = { "cat_atk": ["Sudden Death", "Explosion", "Great Fireball", "Heavy Magic Missile", "Light Magic Missile", "Fireball", "Ultimate Healing", "Intense Healing", "Envenom"], "cat_sup": ["Paralyze", "Magic Wall", "Energy Bomb", "Energy Wall", "Fire Bomb", "Fire Wall", "Poison Bomb", "Poison Wall", "Soulfire", "Animate Dead", "Convince Creature", "Chameleon", "Desintegrate", "Destroy Field"] }

# URLS E LINKS (V22 + V37)
RASHID_SCHEDULE = {
    0: {"city": "Thais", "desc": "Ao lado direito do DP.", "url": "https://tibiamaps.io/map#32359,32226,6:3"},
    1: {"city": "Venore", "desc": "Loja ao sul.", "url": "https://tibiamaps.io/map#32945,32110,6:3"},
    2: {"city": "Ab'Dendriel", "desc": "Taverna.", "url": ""},
    3: {"city": "Ankrahmun", "desc": "Post Office.", "url": "https://tibiamaps.io/map#33069,32882,6:4"},
    4: {"city": "Darashia", "desc": "Taverna.", "url": "https://tibiamaps.io/map#33235,32485,7:3"},
    5: {"city": "Edron", "desc": "Acima do DP.", "url": "https://tibiamaps.io/map#33170,31812,6:3"},
    6: {"city": "Carlin", "desc": "DP Andar 1.", "url": "https://tibiamaps.io/map#32334,31782,6:3"}
}
